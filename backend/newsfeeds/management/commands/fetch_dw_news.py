...
DW_FEEDS = {
    "top_stories": "https://rss.dw.com/rdf/rss-en-all",
}


class Command(BaseCommand):
    help = "Fetch DW News RSS feed and store in the database"

    def handle(self, *args, **kwargs):
        total_added = 0
        total_skipped = 0

        for category, url in DW_FEEDS.items():
        ...
        self.stdout.write(self.style.SUCCESS(
            f"✅ DW news fetched successfully! Added {total_added} new articles, skipped {total_skipped} existing ones."
        ))
