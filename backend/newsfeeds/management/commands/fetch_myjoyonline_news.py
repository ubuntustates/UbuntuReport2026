# newsfeeds/management/commands/fetch_myjoyonline_news.py
...
MYJOYONLINE_FEED = "https://www.myjoyonline.com/feed/"

class Command(BaseCommand):
    help = "Fetch MyJoyOnline RSS feed and store in the database"

    def handle(self, *args, **kwargs):
        total_added = 0
        total_skipped = 0

        self.stdout.write("📡 Fetching MyJoyOnline...")
        feed = feedparser.parse(MYJOYONLINE_FEED)
