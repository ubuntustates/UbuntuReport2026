...
FRANCE24_FEEDS = {
    "news": "https://www.france24.com/en/rss",
}


class Command(BaseCommand):
    help = "Fetch France 24 RSS feed and store in the database"

    def handle(self, *args, **kwargs):
        total_added = 0
        total_skipped = 0

        for category, url in FRANCE24_FEEDS.items():
        ...
        self.stdout.write(self.style.SUCCESS(
            f"✅ France 24 news fetched successfully! Added {total_added} new articles, skipped {total_skipped} existing ones."
        ))
