...
NPR_FEEDS = {
    "top_news": "https://feeds.npr.org/1004/rss.xml",
}


class Command(BaseCommand):
    help = "Fetch NPR World News RSS feed and store in the database"

    def handle(self, *args, **kwargs):
        total_added = 0
        total_skipped = 0

        for category, url in NPR_FEEDS.items():
        ...
        self.stdout.write(self.style.SUCCESS(
            f"✅ NPR World News fetched successfully! Added {total_added} new articles, skipped {total_skipped} existing ones."
        ))
