...
class Command(BaseCommand):
    help = "Fetch Sky News RSS feed and store in the database"

    def handle(self, *args, **kwargs):
        total_added = 0
        total_skipped = 0

        for category, url in SKYNEWS_FEEDS.items():
        ...
        self.stdout.write(self.style.SUCCESS(
            f"✅ Sky News fetched successfully! Added {total_added} new articles, skipped {total_skipped} existing ones."
        ))
